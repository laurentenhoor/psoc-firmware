    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'S', (uint8)'h', (uint8)'r', (uint8)'e', (uint8)'y', (uint8)'_', (uint8)'S', (uint8)'B', (uint8)'S', (uint8)'_',
(uint8)'0', (uint8)'1', 
    ...
    0x90u, 0x00u, 0xA0u, 0x00u, 0x00u, 0x00u, 0xC8u, 0x00u, 
...
0x00u, 0x00u, 0x00u, 
    ...
    (uint8)'T', (uint8)'e', (uint8)'s', (uint8)'t', 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u,
0x00u, 0x00u, 0x01u, 0x29u, 0x00u, 0x00u, 
...
const uint8 cyBle_attUuid128[][16u] = {
    /* Test */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xF0u, 0x30u, 0x00u, 0x00u },
    /* Test */
    { 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0xE6u, 0x63u, 0x00u, 0x00u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0001u, (void *)&cyBle_attValues[22] }, /* Central Address Resolution */
    { 0x0004u, (void *)&cyBle_attValues[23] }, /* Service Changed */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[0] }, /* Client Characteristic Configuration */
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* Test UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Test UUID */
    { 0x0014u, (void *)&cyBle_attValues[27] }, /* Test */
    { 0x0004u, (void *)&cyBle_attValues[47] }, /* Characteristic User Description */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x12u] = {
    ...
    { 0x000Eu, 0x2800u /* Primary service                     */, 0x00080001u /*           */, 0x0012u, {{0x0010u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Fu, 0x2803u /* Characteristic                      */, 0x00001A01u /* rd,wr,ntf */, 0x0012u, {{0x0010u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0010u, 0x63E6u /* Test                                */, 0x00091A04u /* rd,wr,ntf */, 0x0012u, {{0x0014u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0011u, 0x2901u /* Characteristic User Description     */, 0x00090204u /* rd        */, 0x0011u, {{0x0004u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0012u, 0x2902u /* Client Characteristic Configuration */, 0x00090A04u /* rd,wr     */, 0x0012u, {{0x0002u, (void *)&cyBle_attValuesLen[10]}} },
};
