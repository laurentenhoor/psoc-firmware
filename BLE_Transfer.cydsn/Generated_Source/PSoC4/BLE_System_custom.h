...
#define CYBLE_TEST_SERVICE_INDEX   (0x00u) /* Index of Test service in the cyBle_customs array */
#define CYBLE_TEST_TEST_CHAR_INDEX   (0x00u) /* Index of Test characteristic */
#define CYBLE_TEST_TEST_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_TEST_TEST_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */


#define CYBLE_TEST_SERVICE_HANDLE   (0x000Eu) /* Handle of Test service */
#define CYBLE_TEST_TEST_DECL_HANDLE   (0x000Fu) /* Handle of Test characteristic declaration */
#define CYBLE_TEST_TEST_CHAR_HANDLE   (0x0010u) /* Handle of Test characteristic */
#define CYBLE_TEST_TEST_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0011u) /* Handle of Characteristic User Description descriptor */
#define CYBLE_TEST_TEST_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0012u) /* Handle of Client Characteristic Configuration descriptor */
