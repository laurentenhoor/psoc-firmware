// ======================================================================
// BLE_Transfer.v generated from TopDesign.cysch
// 02/26/2018 at 08:17
...
module BLE_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("dd2d5ece-26b1-45c3-9186-6fc07d705095/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
// SW_Tx_UART_v1_50(BaudRate=115200, PinAssignmentMethod=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=SW_Tx_UART_v1_50, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UART_Dbg, CY_INSTANCE_SHORT_NAME=UART_Dbg, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=50, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=UART_Dbg, )
module SW_Tx_UART_v1_50_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("4c12dc6c-4b62-498e-967d-cee957bb4a32/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("2ebf4a09-0be9-4aa4-a330-d66d8565c48d"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PWR_CTR1_net;
	wire [0:0] tmpFB_0__PWR_CTR1_net;
	wire [0:0] tmpIO_0__PWR_CTR1_net;
	wire [0:0] tmpINTERRUPT_0__PWR_CTR1_net;
	electrical [0:0] tmpSIOVREF__PWR_CTR1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		PWR_CTR1
		 (.oe(tmpOE__PWR_CTR1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PWR_CTR1_net[0:0]}),
		  .io({tmpIO_0__PWR_CTR1_net[0:0]}),
		  .siovref(tmpSIOVREF__PWR_CTR1_net),
		  .interrupt({tmpINTERRUPT_0__PWR_CTR1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWR_CTR1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    SW_Tx_UART_v1_50_1 UART_Dbg ();

	wire [0:0] tmpOE__PWR_CTR2_net;
	wire [0:0] tmpFB_0__PWR_CTR2_net;
	wire [0:0] tmpIO_0__PWR_CTR2_net;
	wire [0:0] tmpINTERRUPT_0__PWR_CTR2_net;
	electrical [0:0] tmpSIOVREF__PWR_CTR2_net;

	cy_psoc3_pins_v1_10
		#(.id("95657e77-3a5c-406a-8854-5dd2dc32fecf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWR_CTR2
		 (.oe(tmpOE__PWR_CTR2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PWR_CTR2_net[0:0]}),
		  .io({tmpIO_0__PWR_CTR2_net[0:0]}),
		  .siovref(tmpSIOVREF__PWR_CTR2_net),
		  .interrupt({tmpINTERRUPT_0__PWR_CTR2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWR_CTR2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWR_CTR3_net;
	wire [0:0] tmpFB_0__PWR_CTR3_net;
	wire [0:0] tmpIO_0__PWR_CTR3_net;
	wire [0:0] tmpINTERRUPT_0__PWR_CTR3_net;
	electrical [0:0] tmpSIOVREF__PWR_CTR3_net;

	cy_psoc3_pins_v1_10
		#(.id("230faded-9b80-41c2-8f7a-ca4beeade12c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWR_CTR3
		 (.oe(tmpOE__PWR_CTR3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PWR_CTR3_net[0:0]}),
		  .io({tmpIO_0__PWR_CTR3_net[0:0]}),
		  .siovref(tmpSIOVREF__PWR_CTR3_net),
		  .interrupt({tmpINTERRUPT_0__PWR_CTR3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWR_CTR3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PWR_CTR4_net;
	wire [0:0] tmpFB_0__PWR_CTR4_net;
	wire [0:0] tmpIO_0__PWR_CTR4_net;
	wire [0:0] tmpINTERRUPT_0__PWR_CTR4_net;
	electrical [0:0] tmpSIOVREF__PWR_CTR4_net;

	cy_psoc3_pins_v1_10
		#(.id("52843ee5-fd39-49cc-8c98-0796fe3b571a"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWR_CTR4
		 (.oe(tmpOE__PWR_CTR4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PWR_CTR4_net[0:0]}),
		  .io({tmpIO_0__PWR_CTR4_net[0:0]}),
		  .siovref(tmpSIOVREF__PWR_CTR4_net),
		  .interrupt({tmpINTERRUPT_0__PWR_CTR4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWR_CTR4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__pwr_set_net;
	wire [0:0] tmpFB_0__pwr_set_net;
	wire [0:0] tmpIO_0__pwr_set_net;
	wire [0:0] tmpINTERRUPT_0__pwr_set_net;
	electrical [0:0] tmpSIOVREF__pwr_set_net;

	cy_psoc3_pins_v1_10
		#(.id("cf609ea7-5d70-4ffe-a39f-5a6d3288dd87"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pwr_set
		 (.oe(tmpOE__pwr_set_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__pwr_set_net[0:0]}),
		  .io({tmpIO_0__pwr_set_net[0:0]}),
		  .siovref(tmpSIOVREF__pwr_set_net),
		  .interrupt({tmpINTERRUPT_0__pwr_set_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pwr_set_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
