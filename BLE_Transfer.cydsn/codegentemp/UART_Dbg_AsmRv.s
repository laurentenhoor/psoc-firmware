...
;==============================================================================
    ...
    IMPORT UART_Dbg_pinNumber
    IMPORT UART_Dbg_pinPortNumber
    IMPORT UART_Dbg_pinDrAdress
...
;-------------------------------------------------------------------------------
; Function Name: UART_Dbg_PutChar
;-------------------------------------------------------------------------------
;
; Summary:
...
; void UART_Dbg_PutChar(uint8 txDataByte)
    ALIGN 8
UART_Dbg_PutChar FUNCTION
    EXPORT UART_Dbg_PutChar
...
PIN_NUMBER DCD UART_Dbg_pinNumber
PORT_NUMBER DCD UART_Dbg_pinPortNumber
PORT_DR_ADDRESS DCD UART_Dbg_pinDrAdress
